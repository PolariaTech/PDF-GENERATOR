const fs = require('fs');
const data = JSON.parse(fs.readFileSync(String.raw`C:\Users\DG\.claude\projects\D--POLARIA-PDF-GENERATOR\00567d3d-f882-443d-938a-fde00e39629d\tool-results\mcp-claude_ai_n8n-get_execution-1784143999787.txt`, 'utf-8'));
...
const norm = rd['Normalizar y Validar Fila del Sprint1'][0].data.main[0][0].json;
...
console.log('source:', JSON.stringify(marcarNode.source));
