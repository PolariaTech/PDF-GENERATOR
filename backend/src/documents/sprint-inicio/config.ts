...
- Algunos members tienen, ademas de sus proyectos, un subtitulo "Personalización" con issues sin proyecto asignado (trabajo directo, sin lead de proyecto). Usa ese trabajo como contexto adicional al redactar el "objetivo" de esa persona si aplica -- pero NUNCA lo agregues al array "projects", y el campo "personalizacion" de cada member siempre debe quedar como un array vacio []: ese campo lo completa otro proceso por fuera de tu respuesta, no tu.
